            ...
            <div class="flex lg:gap-10 md:gap-5 lg:px-20 md:px-7 sm:px-5 px-3 justify-center">
                <div class="h-full md:w-[70%]">
                    <div class="bg-white border sm:px-10 px-3 rounded-2xl py-3">
                        <p class="font-bold capitalize text-2xl py-5">shop shoe</p>
                        <div class="pictures relative lg:h-[60vh] md:h-[55vh] h-[50vh]">
                            <img src="{{ url('image/sneaker/sneaker (6).jpeg') }}" alt="" srcset="" class="w-full lg:h-[60vh] md:h-[55vh] h-[50vh] mb-4 rounded-2xl absolute" id="firstheel">
                            <img src="{{ url('image/sneaker/sneaker (1).jpeg') }}" alt="" srcset="" class="w-full lg:h-[60vh] md:h-[55vh] h-[50vh] mb-4 rounded-2xl absolute" style="display: none;" id="secondheel">
                            <img src="{{ url('image/sneaker/sneaker (3).jpeg') }}" alt="" srcset="" class="w-full lg:h-[60vh] md:h-[55vh] h-[50vh] mb-4 rounded-2xl absolute" style="display: none;" id="thirdheel">
                            <img src="{{ url('image/sneaker/sneaker (4).jpeg') }}" alt="" srcset="" class="w-full lg:h-[60vh] md:h-[55vh] h-[50vh] mb-4 rounded-2xl absolute" style="display: none;" id="fourthheel">
                        </div>
                        <div class="flex whitespace-nowrap items-center justify-center py-4 md:py-8">
                            <button type="button" class="me-3 mb-3 content rounded-xl active current:border current:border-black" id="first" onclick="firstHeel()">
                                <img src="{{ url('image/sneaker/sneaker (6).jpeg') }}" alt="" srcset="" class="w-[80px] h-[70px] rounded-xl">
                            </button>
                            <button type="button" class=" me-3 mb-3 content rounded-xl" id="second" onclick="secondHeel()">
                                <img src="{{ url('image/sneaker/sneaker (1).jpeg') }}" alt="" srcset="" class="w-[80px] h-[70px] rounded-xl">
                            </button>
                            <button type="button" class="  me-3 mb-3 content rounded-xl" id="third" onclick="thirdHeel()">
                                <img src="{{ url('image/sneaker/sneaker (3).jpeg') }}" alt="" srcset="" class="w-[80px] h-[70px] rounded-xl">
                            </button>
                            <button type="button" class="  me-3 mb-3 content rounded-xl" id="fourth" onclick="fourthHeel()">
                                <img src="{{ url('image/sneaker/sneaker (4).jpeg') }}" alt="" srcset="" class="w-[80px] h-[70px] rounded-xl">
                            </button>
                        </div>
                        <hr>
                        <p class="py-3 xs:text-xl text-sm font-medium uppercase">
                            sneakers fashion casual running <br>shoes light breathe comfort <br> outdoor
                        </p>
                        <hr>
                        <div class="px-2 py-3 md:hidden block">
                            ...
                            <div class="bg-gray-200 md:h-md lg:h-lg sm:w-[15em] xs:w-[20em] lg:my-3 my-2 text-center py-2 rounded">
                                <p class="text-yellow-500"><span class="sm:text-3xl text-2xl font-bold">3</span><span class="sm:text-3xl text-2xl font-small">/5</span></p>
                    ...
                    <div class="bg-white border sm:px-10 px-2 rounded-2xl py-4 mt-4">
                        ...
                        <div class="grid md:grid-cols-2 grid-cols-1 gap-3">
                            <div class="">
                                ...
                                <div class="w-full py-4 h-[55vh] px-7 border capitalize rounded-b-lg">
                                    <ul class="list-disc">
                                        ...
                                        <li class="pt-2">Style: OL.</li>
                                        <li class="pt-2">Buckle: Lace-up.</li>
                                        <li class="pt-2">Upper Material: Leather.</li>
                                        <li class="pt-2">Sole material: Natural Rubber.</li>
                                        <li class="pt-2">Season: All Seasons.</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="">
                                <div class="w-full py-3 px-4 uppercase font-medium border rounded-t-lg">what's in the box</div>
                                <div class="w-full py-4 h-[55vh] px-4 border capitalize rounded-b-lg">
                                    <ul>
                            ...
                            <div class="">
                                ...
                                <div class="w-full py-4 px-4 border capitalize rounded-b-lg">
                                    <p class="pt-1 lg:text-lg md:text-xs sm:text-lg text-xs"><span class="font-bold">SKU:</span><span> FA203FS214LKPNAFAMZ</span></p>
                                    <p class="pt-2 lg:text-lg md:text-xs sm:text-lg text-xs"><span class="font-bold">Product Line:</span> <span> ALagzi official store-COD</span></p>
                                    <p class="pt-2 lg:text-lg md:text-xs sm:text-lg text-xs"><span class="font-bold">Model:</span><span> Fashion Sneakers</span></p>
                                    <p class="pt-2 lg:text-lg md:text-xs sm:text-lg text-xs"><span class="font-bold">Size (L x W x H cm)</span><span>: 18*12*10</span></p>
                                    <p class="pt-2 lg:text-lg md:text-xs sm:text-lg text-xs"><span class="font-bold">Weight (kg)</span><span>: 0.5</span></p>
                                    <p class="pt-2 lg:text-lg md:text-xs sm:text-lg text-xs"><span class="font-bold">Color</span><span>: Mixed</span></p>
                                    <p class="pt-2 lg:text-lg md:text-xs sm:text-lg text-xs"><span class="font-bold">Main Material</span><span>: N/A</span></p>
                ...
                <div class="bg-white h-full xl:w-[20%] lg:w-[30%] md:w-[30%] border rounded-2xl sticky top-20 md:block hidden">
                    <div class="">
                        <img src="{{ url('image/sneaker/sneaker (3).jpeg') }}" alt="" srcset="" class="w-full h-[150px] rounded-t-2xl">
                        <div class="px-2 py-3">
                            <p class="flex lg:py-2 py-1 items-center justify-end">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" class="w-4 h-4 font-medium mr-1" viewBox="0 0 256 256" xml:space="preserve">
                                    <defs>
                            ...
                            <hr>
                            <p class="uppercase text-red-700 font-bold sm:text-md md:text-lg lg:text-2xl pt-2">ngn <span class="sm:text-xl md:text-2xl lg:text-4xl">20,002</span><span>.10</span></p>
                            <p class=" font-bold "><span class="line-through sm:text-md md:text-lg lg:text-xl">NGN50,000.40</span> <span class="bg-pink-200 text-yellow-600 lg:text-md md:text-xs ml-2">-70%</span></p>
                            <hr>
                            <div class="bg-gray-200 md:h-md lg:h-lg w-full lg:my-3 my-2 text-center lg:py-2 rounded">
                                <p class="text-yellow-500"><span class="md:text-3xl lg:text-5xl font-bold">3</span><span class="md:text-3xl lg:text-5xl font-small">/5</span></p>
                                <div class="star flex py-3 justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="lg:h-6 lg:w-6 h-5 w-5 fill-yellow-500">
                                        <path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z" />
                                    </svg>
